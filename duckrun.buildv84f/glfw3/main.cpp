...
extern c_Game_app* bb_duckrun_Game;
int bbMain();
...
String dbg_type(c_Duck**p){return "Duck";}
class c_log : public Object{
	public:
	Float m_x;
	Float m_y;
	c_Image* m_sprite;
...
String dbg_type(c_log**p){return "log";}
class c_List : public Object{
	public:
	c_Node2* m__head;
	c_List();
	c_List* m_new();
	c_Node2* p_AddLast(c_log*);
	c_List* m_new2(Array<c_log* >);
	c_Enumerator* p_ObjectEnumerator();
	bool p_Equals(c_log*,c_log*);
	int p_RemoveEach(c_log*);
	void p_Remove(c_log*);
	void mark();
	String debug();
};
...
class c_Node2 : public Object{
	...
	c_log* m__data;
	c_Node2();
	c_Node2* m_new(c_Node2*,c_Node2*,c_log*);
	c_Node2* m_new2();
	int p_Remove2();
	void mark();
	String debug();
...
class c_worm : public Object{
	public:
	Float m_x;
	Float m_y;
	c_Image* m_sprite;
	c_worm();
	c_worm* m_new(int,int);
	c_worm* m_new2();
	void mark();
	String debug();
};
String dbg_type(c_worm**p){return "worm";}
class c_List2 : public Object{
	public:
	c_Node3* m__head;
	c_List2();
	c_List2* m_new();
	c_Node3* p_AddLast2(c_worm*);
	c_List2* m_new2(Array<c_worm* >);
	c_Enumerator2* p_ObjectEnumerator();
	bool p_Equals2(c_worm*,c_worm*);
	int p_RemoveEach2(c_worm*);
	void p_Remove3(c_worm*);
	void mark();
	String debug();
};
...
class c_Node3 : public Object{
	...
	c_worm* m__data;
	c_Node3();
	c_Node3* m_new(c_Node3*,c_Node3*,c_worm*);
	c_Node3* m_new2();
	int p_Remove2();
	void mark();
	String debug();
...
bool bb_duckrun_intersects(int,int,int,int,int,int,int,int);
...
c_Game_app* c_Game_app::m_new(){
	...
	DBG_LOCAL(self,"Self")
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun.monkey<13>");
	c_App::m_new();
	return this;
}
int c_Game_app::p_OnCreate(){
	...
	c_Game_app *self=this;
	DBG_LOCAL(self,"Self")
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun.monkey<29>");
	bb_audio_PlayMusic(String(L"RiverMusic.ogg",14),1);
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun.monkey<30>");
	bb_app_SetUpdateRate(60);
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun.monkey<31>");
	gc_assign(m_menu,bb_graphics_LoadImage(String(L"homepage.png",12),1,c_Image::m_DefaultFlags));
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun.monkey<32>");
	gc_assign(m_background,bb_graphics_LoadImage(String(L"background.png",14),1,c_Image::m_DefaultFlags));
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun.monkey<33>");
	gc_assign(m_player,(new c_Duck)->m_new());
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun.monkey<34>");
	gc_assign(m_enemy_collection,(new c_List)->m_new());
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun.monkey<35>");
	gc_assign(m_worm_collection,(new c_List2)->m_new());
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun.monkey<36>");
	m_enemy_collection->p_AddLast((new c_log)->m_new(90,0));
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun.monkey<37>");
	m_enemy_collection->p_AddLast((new c_log)->m_new(205,0));
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun.monkey<38>");
	m_worm_collection->p_AddLast2((new c_worm)->m_new(320,0));
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun.monkey<39>");
...
int c_Game_app::m_highscore;
int c_Game_app::p_OnUpdate(){
	DBG_ENTER("Game_app.OnUpdate")
	c_Game_app *self=this;
	DBG_LOCAL(self,"Self")
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun.monkey<44>");
	String t_1=m_GameState;
	DBG_LOCAL(t_1,"1")
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun.monkey<45>");
	if(t_1==String(L"GAMEOVER",8)){
		DBG_BLOCK();
		DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun.monkey<46>");
		if((bb_input_KeyHit(13))!=0){
			DBG_BLOCK();
			DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun.monkey<47>");
			bb_duckrun_score=0;
			DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun.monkey<48>");
			m_endgame=0;
			DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun.monkey<49>");
			m_speed=FLOAT(0.0);
			DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun.monkey<51>");
			m_GameState=String(L"MENU",4);
		}
	}else{
		DBG_BLOCK();
		DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun.monkey<53>");
		if(t_1==String(L"MENU",4)){
			DBG_BLOCK();
			DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun.monkey<54>");
			bb_duckrun_score=0;
			DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun.monkey<55>");
			m_endgame=0;
			DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun.monkey<56>");
			m_speed=FLOAT(0.0);
			DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun.monkey<57>");
			...
			DBG_BLOCK();
			DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun.monkey<58>");
			if(t_1==String(L"PLAYING",7)){
				DBG_BLOCK();
				DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun.monkey<59>");
				if((bb_input_KeyHit(27))!=0){
					DBG_BLOCK();
					m_GameState=String(L"MENU",4);
				}
				DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun.monkey<60>");
				if((bb_input_KeyDown(37))!=0){
					DBG_BLOCK();
					m_player->p_Move(-15);
				}
				DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun.monkey<61>");
				if((bb_input_KeyDown(39))!=0){
					DBG_BLOCK();
					m_player->p_Move(15);
				}
				DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun.monkey<64>");
				Float t_r=bb_random_Rnd2(FLOAT(1.0),FLOAT(7.0));
				DBG_LOCAL(t_r,"r")
				DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun.monkey<65>");
				c_Enumerator* t_=m_enemy_collection->p_ObjectEnumerator();
				while(t_->p_HasNext()){
					DBG_BLOCK();
					c_log* t_enemy=t_->p_NextObject();
					DBG_LOCAL(t_enemy,"enemy")
					DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun.monkey<66>");
					if(t_enemy->m_y>FLOAT(464.0)){
						DBG_BLOCK();
						DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun.monkey<67>");
						m_enemy_collection->p_Remove(t_enemy);
						DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun.monkey<68>");
						m_PlayState=int(t_r);
						DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun.monkey<69>");
						if(m_PlayState==1){
							DBG_BLOCK();
							DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun.monkey<70>");
							m_enemy_collection->p_AddLast((new c_log)->m_new(90,0));
							DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun.monkey<71>");
							m_enemy_collection->p_AddLast((new c_log)->m_new(320,0));
							DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun.monkey<72>");
							m_worm_collection->p_AddLast2((new c_worm)->m_new(205,0));
						}
						DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun.monkey<74>");
						if(m_PlayState==2){
							DBG_BLOCK();
							DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun.monkey<75>");
							m_enemy_collection->p_AddLast((new c_log)->m_new(90,0));
							DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun.monkey<76>");
							m_enemy_collection->p_AddLast((new c_log)->m_new(205,0));
							DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun.monkey<77>");
							m_worm_collection->p_AddLast2((new c_worm)->m_new(320,0));
						}
						DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun.monkey<79>");
						if(m_PlayState==3){
							DBG_BLOCK();
							DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun.monkey<80>");
							m_enemy_collection->p_AddLast((new c_log)->m_new(205,0));
							DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun.monkey<81>");
							m_enemy_collection->p_AddLast((new c_log)->m_new(320,0));
							DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun.monkey<82>");
							m_worm_collection->p_AddLast2((new c_worm)->m_new(90,0));
						}
						DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun.monkey<84>");
						if(m_PlayState==4){
							DBG_BLOCK();
							DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun.monkey<85>");
							m_enemy_collection->p_AddLast((new c_log)->m_new(90,0));
							DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun.monkey<86>");
							m_enemy_collection->p_AddLast((new c_log)->m_new(320,0));
						}
						DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun.monkey<88>");
						if(m_PlayState==5){
							DBG_BLOCK();
							DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun.monkey<89>");
							m_enemy_collection->p_AddLast((new c_log)->m_new(90,0));
							DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun.monkey<90>");
							m_enemy_collection->p_AddLast((new c_log)->m_new(205,0));
						}
						DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun.monkey<92>");
						if(m_PlayState==6){
							DBG_BLOCK();
							DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun.monkey<93>");
							m_enemy_collection->p_AddLast((new c_log)->m_new(205,0));
							DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun.monkey<94>");
							m_enemy_collection->p_AddLast((new c_log)->m_new(320,0));
						}
					}
				}
				DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun.monkey<98>");
				c_Enumerator2* t_2=m_worm_collection->p_ObjectEnumerator();
				while(t_2->p_HasNext()){
					DBG_BLOCK();
					c_worm* t_worm=t_2->p_NextObject();
					DBG_LOCAL(t_worm,"worm")
					DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun.monkey<99>");
					if(bb_duckrun_intersects(int(m_player->m_x),int(m_player->m_y),10,21,int(t_worm->m_x),int(t_worm->m_y),100,50)){
						DBG_BLOCK();
						DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun.monkey<100>");
						m_worm_collection->p_Remove3(t_worm);
						DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun.monkey<101>");
						bb_duckrun_score=bb_duckrun_score+1;
						DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun.monkey<102>");
						m_speed=m_speed+FLOAT(0.5);
					}
				}
				DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun.monkey<106>");
				c_Enumerator* t_3=m_enemy_collection->p_ObjectEnumerator();
				while(t_3->p_HasNext()){
					DBG_BLOCK();
					c_log* t_enemy2=t_3->p_NextObject();
					DBG_LOCAL(t_enemy2,"enemy")
					DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun.monkey<107>");
					c_Enumerator2* t_4=m_worm_collection->p_ObjectEnumerator();
					while(t_4->p_HasNext()){
						DBG_BLOCK();
						c_worm* t_worm2=t_4->p_NextObject();
						DBG_LOCAL(t_worm2,"worm")
						DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun.monkey<108>");
						if(bb_duckrun_intersects(int(m_player->m_x),int(m_player->m_y),10,21,int(t_enemy2->m_x),int(t_enemy2->m_y),100,50)){
							DBG_BLOCK();
							DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun.monkey<109>");
							gc_assign(m_enemy_collection,(new c_List)->m_new());
							DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun.monkey<110>");
							gc_assign(m_worm_collection,(new c_List2)->m_new());
							DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun.monkey<111>");
							m_enemy_collection->p_AddLast((new c_log)->m_new(90,0));
							DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun.monkey<112>");
							m_enemy_collection->p_AddLast((new c_log)->m_new(205,0));
							DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun.monkey<113>");
							m_worm_collection->p_AddLast2((new c_worm)->m_new(320,0));
							DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun.monkey<114>");
							if(bb_duckrun_score>m_highscore){
								DBG_BLOCK();
								m_highscore=bb_duckrun_score;
							}
							DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun.monkey<115>");
							if(m_highscore>bb_duckrun_score){
								DBG_BLOCK();
								m_highscore=m_highscore;
							}
							DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun.monkey<116>");
							m_endgame=-1;
						}
					}
				}
...
int c_Game_app::p_OnRender(){
	...
	c_Game_app *self=this;
	DBG_LOCAL(self,"Self")
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun.monkey<125>");
	String t_2=m_GameState;
	DBG_LOCAL(t_2,"2")
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun.monkey<126>");
	if(t_2==String(L"MENU",4)){
		DBG_BLOCK();
		DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun.monkey<127>");
		bb_graphics_DrawImage(m_menu,FLOAT(0.0),FLOAT(0.0),0);
	}else{
		DBG_BLOCK();
		DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun.monkey<128>");
		if(t_2==String(L"GAMEOVER",8)){
			DBG_BLOCK();
			DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun.monkey<129>");
			bb_graphics_DrawImage(m_gameover,FLOAT(0.0),FLOAT(0.0),0);
			DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun.monkey<130>");
			bb_graphics_DrawText(String(bb_duckrun_score),FLOAT(510.0),FLOAT(370.0),FLOAT(10.0),FLOAT(10.0));
			DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun.monkey<131>");
			bb_graphics_DrawText(String(m_highscore),FLOAT(510.0),FLOAT(400.0),FLOAT(10.0),FLOAT(10.0));
		}else{
			DBG_BLOCK();
			DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun.monkey<132>");
			if(t_2==String(L"PLAYING",7)){
				DBG_BLOCK();
				DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun.monkey<133>");
				bb_graphics_DrawImage(m_background,FLOAT(0.0),FLOAT(0.0),0);
				DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun.monkey<134>");
				bb_graphics_DrawImage(m_player->m_sprite,m_player->m_x,m_player->m_y,0);
				DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun.monkey<135>");
				bb_graphics_DrawText(String(bb_duckrun_score),FLOAT(40.0),FLOAT(60.0),FLOAT(2.0),FLOAT(2.0));
				DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun.monkey<136>");
				bb_graphics_DrawText(String(m_speed),FLOAT(100.0),FLOAT(60.0),FLOAT(2.0),FLOAT(2.0));
				DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun.monkey<138>");
				c_Enumerator* t_=m_enemy_collection->p_ObjectEnumerator();
				while(t_->p_HasNext()){
					DBG_BLOCK();
					c_log* t_enemy=t_->p_NextObject();
					DBG_LOCAL(t_enemy,"enemy")
					DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun.monkey<139>");
					bb_graphics_DrawImage(t_enemy->m_sprite,t_enemy->m_x,t_enemy->m_y,0);
					DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun.monkey<140>");
					if(m_speed<FLOAT(1.0)){
						DBG_BLOCK();
						t_enemy->m_y=t_enemy->m_y+FLOAT(1.0);
					}
					DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun.monkey<141>");
					if(m_speed>FLOAT(1.0)){
						DBG_BLOCK();
						t_enemy->m_y=t_enemy->m_y+FLOAT(4.0);
					}
				}
				DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun.monkey<143>");
				c_Enumerator2* t_3=m_worm_collection->p_ObjectEnumerator();
				while(t_3->p_HasNext()){
					DBG_BLOCK();
					c_worm* t_worm=t_3->p_NextObject();
					DBG_LOCAL(t_worm,"worm")
					DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun.monkey<144>");
					bb_graphics_DrawImage(t_worm->m_sprite,t_worm->m_x,t_worm->m_y,0);
					DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun.monkey<145>");
					if(m_speed<FLOAT(1.0)){
						DBG_BLOCK();
						t_worm->m_y=t_worm->m_y+FLOAT(1.0);
					}
					DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun.monkey<146>");
					if(m_speed>FLOAT(1.0)){
						DBG_BLOCK();
						t_worm->m_y=t_worm->m_y+FLOAT(3.0);
					}
				}
			}
		}
	}
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun.monkey<149>");
	if(m_endgame==-1){
		DBG_BLOCK();
...
String c_Game_app::debug(){
	...
	t+=dbg_decl("PlayState",&m_PlayState);
	t+=dbg_decl("highscore",&c_Game_app::m_highscore);
	t+=dbg_decl("endgame",&m_endgame);
	t+=dbg_decl("player",&m_player);
	t+=dbg_decl("enemy_collection",&m_enemy_collection);
	t+=dbg_decl("worm_collection",&m_worm_collection);
...
BBGame* bb_app__game;
c_Game_app* bb_duckrun_Game;
int bbMain(){
	DBG_ENTER("Main")
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun.monkey<9>");
	gc_assign(bb_duckrun_Game,(new c_Game_app)->m_new());
	return 0;
}
...
c_Duck* c_Duck::m_new(){
	...
	c_Duck *self=this;
	DBG_LOCAL(self,"Self")
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun.monkey<153>");
	return this;
}
int c_Duck::p_Move(int t_x_distance){
	DBG_ENTER("Duck.Move")
	c_Duck *self=this;
	DBG_LOCAL(self,"Self")
	DBG_LOCAL(t_x_distance,"x_distance")
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun.monkey<158>");
	m_x=m_x+Float(t_x_distance);
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun.monkey<159>");
	if(m_x<FLOAT(90.0)){
		DBG_BLOCK();
		m_x=FLOAT(90.0);
	}
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun.monkey<160>");
	if(m_x>FLOAT(320.0)){
		DBG_BLOCK();
		m_x=FLOAT(320.0);
	}
...
c_log* c_log::m_new(int t_x_spawn,int t_y_spawn){
	DBG_ENTER("log.new")
	c_log *self=this;
	DBG_LOCAL(self,"Self")
	DBG_LOCAL(t_x_spawn,"x_spawn")
	DBG_LOCAL(t_y_spawn,"y_spawn")
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun.monkey<171>");
	m_x=Float(t_x_spawn);
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun.monkey<172>");
	m_y=Float(t_y_spawn);
	return this;
}
c_log* c_log::m_new2(){
	...
	c_log *self=this;
	DBG_LOCAL(self,"Self")
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun.monkey<164>");
	return this;
}
void c_log::mark(){
	Object::mark();
...
c_Node2* c_List::p_AddLast(c_log* t_data){
...
c_List* c_List::m_new2(Array<c_log* > t_data){
	DBG_ENTER("List.new")
	c_List *self=this;
	DBG_LOCAL(self,"Self")
	DBG_LOCAL(t_data,"data")
	DBG_INFO("C:/MonkeyXFree84f/modules/monkey/list.monkey<13>");
	Array<c_log* > t_=t_data;
	int t_2=0;
	while(t_2<t_.Length()){
		DBG_BLOCK();
		c_log* t_t=t_.At(t_2);
...
bool c_List::p_Equals(c_log* t_lhs,c_log* t_rhs){
...
int c_List::p_RemoveEach(c_log* t_value){
...
void c_List::p_Remove(c_log* t_value){
...
c_Node2* c_Node2::m_new(c_Node2* t_succ,c_Node2* t_pred,c_log* t_data){
	DBG_ENTER("Node.new")
	c_Node2 *self=this;
	DBG_LOCAL(self,"Self")
	DBG_LOCAL(t_succ,"succ")
...
c_worm::c_worm(){
	m_x=FLOAT(.0);
	m_y=FLOAT(.0);
	m_sprite=bb_graphics_LoadImage(String(L"worm.png",8),1,c_Image::m_DefaultFlags);
}
c_worm* c_worm::m_new(int t_x_spawn,int t_y_spawn){
	DBG_ENTER("worm.new")
	c_worm *self=this;
	DBG_LOCAL(self,"Self")
	DBG_LOCAL(t_x_spawn,"x_spawn")
	DBG_LOCAL(t_y_spawn,"y_spawn")
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun.monkey<189>");
	m_x=Float(t_x_spawn);
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun.monkey<190>");
	m_y=Float(t_y_spawn);
	return this;
}
c_worm* c_worm::m_new2(){
	DBG_ENTER("worm.new")
	c_worm *self=this;
	DBG_LOCAL(self,"Self")
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun.monkey<183>");
	return this;
}
void c_worm::mark(){
	Object::mark();
...
c_Node3* c_List2::p_AddLast2(c_worm* t_data){
	DBG_ENTER("List.AddLast")
	c_List2 *self=this;
	DBG_LOCAL(self,"Self")
	DBG_LOCAL(t_data,"data")
...
c_List2* c_List2::m_new2(Array<c_worm* > t_data){
	DBG_ENTER("List.new")
	c_List2 *self=this;
	DBG_LOCAL(self,"Self")
	DBG_LOCAL(t_data,"data")
	DBG_INFO("C:/MonkeyXFree84f/modules/monkey/list.monkey<13>");
	Array<c_worm* > t_=t_data;
	int t_2=0;
	while(t_2<t_.Length()){
		DBG_BLOCK();
		c_worm* t_t=t_.At(t_2);
		t_2=t_2+1;
		DBG_LOCAL(t_t,"t")
		DBG_INFO("C:/MonkeyXFree84f/modules/monkey/list.monkey<14>");
		p_AddLast2(t_t);
...
bool c_List2::p_Equals2(c_worm* t_lhs,c_worm* t_rhs){
	DBG_ENTER("List.Equals")
	c_List2 *self=this;
	DBG_LOCAL(self,"Self")
	DBG_LOCAL(t_lhs,"lhs")
...
int c_List2::p_RemoveEach2(c_worm* t_value){
	DBG_ENTER("List.RemoveEach")
	c_List2 *self=this;
	DBG_LOCAL(self,"Self")
	DBG_LOCAL(t_value,"value")
...
void c_List2::p_Remove3(c_worm* t_value){
	DBG_ENTER("List.Remove")
	c_List2 *self=this;
	DBG_LOCAL(self,"Self")
	DBG_LOCAL(t_value,"value")
...
c_Node3* c_Node3::m_new(c_Node3* t_succ,c_Node3* t_pred,c_worm* t_data){
	DBG_ENTER("Node.new")
	c_Node3 *self=this;
	DBG_LOCAL(self,"Self")
	DBG_LOCAL(t_succ,"succ")
...
c_worm* c_Enumerator2::p_NextObject(){
	DBG_ENTER("Enumerator.NextObject")
	c_Enumerator2 *self=this;
	DBG_LOCAL(self,"Self")
	DBG_INFO("C:/MonkeyXFree84f/modules/monkey/list.monkey<338>");
	c_worm* t_data=m__curr->m__data;
	DBG_LOCAL(t_data,"data")
	DBG_INFO("C:/MonkeyXFree84f/modules/monkey/list.monkey<339>");
	gc_assign(m__curr,m__curr->m__succ);
	DBG_INFO("C:/MonkeyXFree84f/modules/monkey/list.monkey<340>");
...
bool bb_duckrun_intersects(int t_x1,int t_y1,int t_w1,int t_h1,int t_x2,int t_y2,int t_w2,int t_h2){
	...
	DBG_LOCAL(t_w2,"w2")
	DBG_LOCAL(t_h2,"h2")
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun.monkey<198>");
	if(t_x1>=t_x2+t_w2 || t_x1+t_w1<=t_x2){
		DBG_BLOCK();
		return false;
	}
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun.monkey<199>");
	if(t_y1>=t_y2+t_h2 || t_y1+t_h1<=t_y2){
		DBG_BLOCK();
		return false;
	}
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun.monkey<200>");
	return true;
}
int bb_graphics_DebugRenderDevice(){
...
int bbInit(){
	...
	bb_duckrun_Game=0;
	DBG_GLOBAL("Game",&bb_duckrun_Game);
	...
	bb_duckrun_score=0;
	DBG_GLOBAL("score",&bb_duckrun_score);
	bb_random_Seed=1234;
	DBG_GLOBAL("Seed",&bb_random_Seed);
	c_Game_app::m_highscore=0;
	DBG_GLOBAL("highscore",&c_Game_app::m_highscore);
	return 0;
}
void gc_mark(){
	gc_mark_q(bb_app__app);
	gc_mark_q(bb_app__delegate);
	gc_mark_q(bb_duckrun_Game);
