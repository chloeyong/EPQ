...
class c_Game_app : public c_App{
	public:
	c_Image* m_menu;
	c_Image* m_background;
	c_Rocket* m_player;
	c_List* m_fish_collection;
	c_List2* m_enemy_collection;
	c_List3* m_missile_collection;
	c_Image* m_gameover;
	c_Game_app();
	c_Game_app* m_new();
	int p_OnCreate();
...
extern c_Game_app* bb_duckrun original_Game;
int bbMain();
...
String dbg_type(c_Rocket**p){return "Rocket";}
class c_flounder : public Object{
	public:
	Float m_x;
	Float m_y;
	c_Image* m_sprite;
	c_flounder();
	c_flounder* m_new(int,int);
	c_flounder* m_new2();
	void mark();
	String debug();
};
String dbg_type(c_flounder**p){return "flounder";}
class c_List : public Object{
	public:
	c_Node2* m__head;
	c_List();
	c_List* m_new();
	c_Node2* p_AddLast(c_flounder*);
	c_List* m_new2(Array<c_flounder* >);
	c_Enumerator2* p_ObjectEnumerator();
	bool p_Equals(c_flounder*,c_flounder*);
	int p_RemoveEach(c_flounder*);
	void p_Remove(c_flounder*);
	void mark();
	String debug();
};
...
class c_Node2 : public Object{
	...
	c_flounder* m__data;
	c_Node2();
	c_Node2* m_new(c_Node2*,c_Node2*,c_flounder*);
	c_Node2* m_new2();
	int p_Remove2();
	void mark();
	String debug();
...
class c_alien : public Object{
	public:
	Float m_x;
	Float m_y;
	c_Image* m_sprite;
	c_alien();
	c_alien* m_new(int,int);
	c_alien* m_new2();
	void mark();
	String debug();
};
String dbg_type(c_alien**p){return "alien";}
class c_List2 : public Object{
	public:
	c_Node3* m__head;
	c_List2();
	c_List2* m_new();
	c_Node3* p_AddLast2(c_alien*);
	c_List2* m_new2(Array<c_alien* >);
...
class c_Node3 : public Object{
	...
	c_alien* m__data;
	c_Node3();
	c_Node3* m_new(c_Node3*,c_Node3*,c_alien*);
	c_Node3* m_new2();
	void mark();
	String debug();
};
...
class c_Laser : public Object{
	public:
	Float m_x;
	Float m_y;
	c_Image* m_sprite;
	c_Laser();
	c_Laser* m_new(int,int);
	c_Laser* m_new2();
	int p_Move(int);
	void mark();
	String debug();
};
String dbg_type(c_Laser**p){return "Laser";}
class c_List3 : public Object{
	public:
	c_Node4* m__head;
	c_List3();
	c_List3* m_new();
	c_Node4* p_AddLast3(c_Laser*);
	c_List3* m_new2(Array<c_Laser* >);
	c_Enumerator* p_ObjectEnumerator();
	bool p_Equals2(c_Laser*,c_Laser*);
	int p_RemoveEach2(c_Laser*);
	void p_Remove3(c_Laser*);
	void mark();
	String debug();
};
...
class c_Node4 : public Object{
	...
	c_Laser* m__data;
	c_Node4();
	c_Node4* m_new(c_Node4*,c_Node4*,c_Laser*);
	c_Node4* m_new2();
	int p_Remove2();
	void mark();
	String debug();
...
class c_Enumerator2 : public Object{
	...
	bool p_HasNext();
	c_flounder* p_NextObject();
	void mark();
	String debug();
};
String dbg_type(c_Enumerator2**p){return "Enumerator";}
bool bb_duckrun original_intersects(int,int,int,int,int,int,int,int);
extern int bb_duckrun original_score;
...
extern String bb_duckrun original_currentdir;
...
c_Game_app* c_Game_app::m_new(){
	...
	DBG_LOCAL(self,"Self")
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun original.monkey<16>");
	c_App::m_new();
	return this;
}
int c_Game_app::p_OnCreate(){
	...
	c_Game_app *self=this;
	DBG_LOCAL(self,"Self")
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun original.monkey<29>");
	bb_audio_PlayMusic(String(L"RiverMusic.ogg",14),1);
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun original.monkey<30>");
	bb_app_SetUpdateRate(60);
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun original.monkey<31>");
	gc_assign(m_menu,bb_graphics_LoadImage(String(L"homepage.png",12),1,c_Image::m_DefaultFlags));
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun original.monkey<32>");
	gc_assign(m_background,bb_graphics_LoadImage(String(L"background.png",14),1,c_Image::m_DefaultFlags));
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun original.monkey<33>");
	gc_assign(m_player,(new c_Rocket)->m_new());
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun original.monkey<34>");
	gc_assign(m_fish_collection,(new c_List)->m_new());
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun original.monkey<35>");
	gc_assign(m_enemy_collection,(new c_List2)->m_new());
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun original.monkey<36>");
	m_fish_collection->p_AddLast((new c_flounder)->m_new(150,250));
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun original.monkey<37>");
	m_enemy_collection->p_AddLast2((new c_alien)->m_new(50,250));
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun original.monkey<38>");
	m_enemy_collection->p_AddLast2((new c_alien)->m_new(250,250));
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun original.monkey<39>");
	m_enemy_collection->p_AddLast2((new c_alien)->m_new(450,250));
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun original.monkey<40>");
	gc_assign(m_missile_collection,(new c_List3)->m_new());
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun original.monkey<41>");
	gc_assign(m_gameover,bb_graphics_LoadImage(String(L"gameover.png",12),1,c_Image::m_DefaultFlags));
	return 0;
}
...
int c_Game_app::p_OnUpdate(){
	...
	c_Game_app *self=this;
	DBG_LOCAL(self,"Self")
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun original.monkey<46>");
	String t_1=m_GameState;
	DBG_LOCAL(t_1,"1")
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun original.monkey<47>");
	if(t_1==String(L"GAMEOVER",8)){
		DBG_BLOCK();
	}else{
		DBG_BLOCK();
		DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun original.monkey<48>");
		if(t_1==String(L"MENU",4)){
			DBG_BLOCK();
			DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun original.monkey<49>");
			...
			DBG_BLOCK();
			DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun original.monkey<50>");
			if(t_1==String(L"PLAYING",7)){
				DBG_BLOCK();
				DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun original.monkey<51>");
				if((bb_input_KeyHit(27))!=0){
					DBG_BLOCK();
					m_GameState=String(L"MENU",4);
				}
				DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun original.monkey<52>");
				if((bb_input_KeyDown(37))!=0){
					DBG_BLOCK();
					m_player->p_Move(-15);
				}
				DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun original.monkey<53>");
				if((bb_input_KeyDown(39))!=0){
					DBG_BLOCK();
					m_player->p_Move(15);
				}
				DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun original.monkey<54>");
				if((bb_input_KeyHit(32))!=0){
					DBG_BLOCK();
					DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun original.monkey<55>");
					m_missile_collection->p_AddLast3((new c_Laser)->m_new(int(m_player->m_x),int(m_player->m_y)));
				}
				DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun original.monkey<58>");
				c_Enumerator* t_=m_missile_collection->p_ObjectEnumerator();
				while(t_->p_HasNext()){
					DBG_BLOCK();
					c_Laser* t_missile=t_->p_NextObject();
					DBG_LOCAL(t_missile,"missile")
					DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun original.monkey<59>");
					t_missile->p_Move(5);
					DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun original.monkey<60>");
					if(t_missile->m_y<FLOAT(10.0)){
						DBG_BLOCK();
						m_missile_collection->p_Remove3(t_missile);
					}
				}
				DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun original.monkey<62>");
				c_Enumerator* t_2=m_missile_collection->p_ObjectEnumerator();
				while(t_2->p_HasNext()){
					DBG_BLOCK();
					c_Laser* t_missile2=t_2->p_NextObject();
					DBG_LOCAL(t_missile2,"missile")
					DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun original.monkey<63>");
					c_Enumerator2* t_3=m_fish_collection->p_ObjectEnumerator();
					while(t_3->p_HasNext()){
						DBG_BLOCK();
						c_flounder* t_fish=t_3->p_NextObject();
						DBG_LOCAL(t_fish,"fish")
						DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun original.monkey<64>");
						if(bb_duckrun original_intersects(int(t_missile2->m_x),int(t_missile2->m_y),10,21,int(t_fish->m_x),int(t_fish->m_y),100,50)){
							DBG_BLOCK();
							DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun original.monkey<65>");
							m_fish_collection->p_Remove(t_fish);
							DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun original.monkey<66>");
							m_missile_collection->p_Remove3(t_missile2);
							DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun original.monkey<67>");
							bb_duckrun original_score=bb_duckrun original_score+1;
							DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun original.monkey<68>");
							m_fish_collection->p_AddLast((new c_flounder)->m_new(int(t_fish->m_x),int(t_fish->m_y-FLOAT(50.0))));
						}
						DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun original.monkey<70>");
						c_Enumerator* t_4=m_missile_collection->p_ObjectEnumerator();
						while(t_4->p_HasNext()){
							DBG_BLOCK();
							c_Laser* t_missile3=t_4->p_NextObject();
							DBG_LOCAL(t_missile3,"missile")
							DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun original.monkey<71>");
							c_Enumerator3* t_5=m_enemy_collection->p_ObjectEnumerator();
							while(t_5->p_HasNext()){
								DBG_BLOCK();
								c_alien* t_enemy=t_5->p_NextObject();
								DBG_LOCAL(t_enemy,"enemy")
								DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun original.monkey<72>");
								if(bb_duckrun original_intersects(int(t_missile3->m_x),int(t_missile3->m_y),10,21,int(t_enemy->m_x),int(t_enemy->m_y),100,50)){
									DBG_BLOCK();
									DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun original.monkey<73>");
									m_missile_collection->p_Remove3(t_missile3);
									DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun original.monkey<74>");
									bb_duckrun original_score=bb_duckrun original_score-1;
								}
							}
						}
...
int c_Game_app::p_OnRender(){
	...
	c_Game_app *self=this;
	DBG_LOCAL(self,"Self")
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun original.monkey<84>");
	String t_2=m_GameState;
	DBG_LOCAL(t_2,"2")
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun original.monkey<85>");
	if(t_2==String(L"MENU",4)){
		DBG_BLOCK();
		DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun original.monkey<86>");
		bb_graphics_DrawImage(m_menu,FLOAT(0.0),FLOAT(0.0),0);
	}else{
		DBG_BLOCK();
		DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun original.monkey<87>");
		if(t_2==String(L"GAMEOVER",8)){
			DBG_BLOCK();
			DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun original.monkey<88>");
			bb_graphics_DrawImage(m_gameover,FLOAT(0.0),FLOAT(0.0),0);
		}else{
			DBG_BLOCK();
			DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun original.monkey<89>");
			if(t_2==String(L"PLAYING",7)){
				DBG_BLOCK();
				DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun original.monkey<90>");
				bb_graphics_DrawImage(m_background,FLOAT(0.0),FLOAT(0.0),0);
				DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun original.monkey<92>");
				bb_graphics_DrawImage(m_player->m_sprite,m_player->m_x,m_player->m_y,0);
				DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun original.monkey<93>");
				bb_graphics_DrawText(String(bb_duckrun original_score),FLOAT(20.0),FLOAT(40.0),FLOAT(2.0),FLOAT(2.0));
				DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun original.monkey<94>");
				c_Enumerator2* t_=m_fish_collection->p_ObjectEnumerator();
				while(t_->p_HasNext()){
					DBG_BLOCK();
					c_flounder* t_fish=t_->p_NextObject();
					DBG_LOCAL(t_fish,"fish")
					DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun original.monkey<95>");
					bb_graphics_DrawImage(t_fish->m_sprite,t_fish->m_x,t_fish->m_y,0);
					DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun original.monkey<96>");
					c_Enumerator3* t_3=m_enemy_collection->p_ObjectEnumerator();
					while(t_3->p_HasNext()){
						DBG_BLOCK();
						c_alien* t_enemy=t_3->p_NextObject();
						DBG_LOCAL(t_enemy,"enemy")
						DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun original.monkey<97>");
						bb_graphics_DrawImage(t_enemy->m_sprite,t_enemy->m_x,t_enemy->m_y,0);
						DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun original.monkey<99>");
						String t_32=bb_duckrun original_currentdir;
						DBG_LOCAL(t_32,"3")
						DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun original.monkey<100>");
						if(t_32==String(L"left",4)){
							DBG_BLOCK();
							DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun original.monkey<101>");
							t_fish->m_x=t_fish->m_x-FLOAT(1.0);
							DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun original.monkey<102>");
							t_enemy->m_x-=FLOAT(1.0);
						}else{
							DBG_BLOCK();
							DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun original.monkey<103>");
							if(t_32==String(L"right",5)){
								DBG_BLOCK();
								DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun original.monkey<104>");
								t_fish->m_x=t_fish->m_x+FLOAT(1.0);
								DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun original.monkey<105>");
								t_enemy->m_x+=FLOAT(1.0);
							}
						}
						DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun original.monkey<107>");
						if(t_fish->m_x<FLOAT(0.0)){
							DBG_BLOCK();
							bb_duckrun original_currentdir=String(L"right",5);
						}
						DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun original.monkey<108>");
						if(t_fish->m_x>FLOAT(624.0)){
							DBG_BLOCK();
							bb_duckrun original_currentdir=String(L"left",4);
						}
						DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun original.monkey<109>");
						if(t_enemy->m_x<FLOAT(0.0)){
							DBG_BLOCK();
							bb_duckrun original_currentdir=String(L"right",5);
						}
						DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun original.monkey<110>");
						if(t_enemy->m_x>FLOAT(624.0)){
							DBG_BLOCK();
							bb_duckrun original_currentdir=String(L"left",4);
						}
						DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun original.monkey<111>");
						if(t_fish->m_y==FLOAT(0.0)){
							DBG_BLOCK();
							m_GameState=String(L"GAMEOVER",8);
						}
						DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun original.monkey<112>");
						if(bb_duckrun original_score<0){
							DBG_BLOCK();
							m_GameState=String(L"GAMEOVER",8);
						}
					}
					DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun original.monkey<114>");
					c_Enumerator* t_4=m_missile_collection->p_ObjectEnumerator();
					while(t_4->p_HasNext()){
						DBG_BLOCK();
						c_Laser* t_missile=t_4->p_NextObject();
						DBG_LOCAL(t_missile,"missile")
						DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun original.monkey<115>");
						bb_graphics_DrawImage(t_missile->m_sprite,t_missile->m_x,t_missile->m_y,0);
					}
				}
			}
		}
...
void c_Game_app::mark(){
	c_App::mark();
	gc_mark_q(m_menu);
	gc_mark_q(m_background);
	gc_mark_q(m_player);
	gc_mark_q(m_fish_collection);
	gc_mark_q(m_enemy_collection);
	gc_mark_q(m_missile_collection);
	gc_mark_q(m_gameover);
}
String c_Game_app::debug(){
	String t="(Game_app)\n";
	t=c_App::debug()+t;
	t+=dbg_decl("menu",&m_menu);
	t+=dbg_decl("background",&m_background);
	t+=dbg_decl("gameover",&m_gameover);
	t+=dbg_decl("GameState",&c_Game_app::m_GameState);
	t+=dbg_decl("player",&m_player);
	t+=dbg_decl("fish_collection",&m_fish_collection);
	t+=dbg_decl("missile_collection",&m_missile_collection);
...
BBGame* bb_app__game;
c_Game_app* bb_duckrun original_Game;
int bbMain(){
	DBG_ENTER("Main")
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun original.monkey<12>");
	gc_assign(bb_duckrun original_Game,(new c_Game_app)->m_new());
	return 0;
}
...
c_Rocket::c_Rocket(){
	m_x=FLOAT(300.0);
	m_y=FLOAT(380.0);
	m_sprite=bb_graphics_LoadImage(String(L"duck.png",8),1,c_Image::m_DefaultFlags);
}
c_Rocket* c_Rocket::m_new(){
	DBG_ENTER("Rocket.new")
	c_Rocket *self=this;
	DBG_LOCAL(self,"Self")
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun original.monkey<122>");
	return this;
}
int c_Rocket::p_Move(int t_x_distance){
	DBG_ENTER("Rocket.Move")
	c_Rocket *self=this;
	DBG_LOCAL(self,"Self")
	DBG_LOCAL(t_x_distance,"x_distance")
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun original.monkey<127>");
	m_x=m_x+Float(t_x_distance);
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun original.monkey<128>");
	if(m_x<FLOAT(0.0)){
		DBG_BLOCK();
		m_x=FLOAT(0.0);
	}
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun original.monkey<129>");
	if(m_x>FLOAT(590.0)){
		DBG_BLOCK();
		m_x=FLOAT(590.0);
	}
...
c_flounder::c_flounder(){
	m_x=FLOAT(.0);
	m_y=FLOAT(.0);
	m_sprite=bb_graphics_LoadImage(String(L"fish.png",8),1,c_Image::m_DefaultFlags);
}
c_flounder* c_flounder::m_new(int t_x_spawn,int t_y_spawn){
	DBG_ENTER("flounder.new")
	c_flounder *self=this;
	DBG_LOCAL(self,"Self")
	DBG_LOCAL(t_x_spawn,"x_spawn")
	DBG_LOCAL(t_y_spawn,"y_spawn")
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun original.monkey<138>");
	m_x=Float(t_x_spawn);
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun original.monkey<139>");
	m_y=Float(t_y_spawn);
	return this;
}
c_flounder* c_flounder::m_new2(){
	DBG_ENTER("flounder.new")
	c_flounder *self=this;
	DBG_LOCAL(self,"Self")
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun original.monkey<133>");
	return this;
}
void c_flounder::mark(){
	Object::mark();
	gc_mark_q(m_sprite);
}
String c_flounder::debug(){
	String t="(flounder)\n";
	t+=dbg_decl("sprite",&m_sprite);
	t+=dbg_decl("x",&m_x);
	t+=dbg_decl("y",&m_y);
...
c_Node2* c_List::p_AddLast(c_flounder* t_data){
...
c_List* c_List::m_new2(Array<c_flounder* > t_data){
	DBG_ENTER("List.new")
	c_List *self=this;
	DBG_LOCAL(self,"Self")
	DBG_LOCAL(t_data,"data")
	DBG_INFO("C:/MonkeyXFree84f/modules/monkey/list.monkey<13>");
	Array<c_flounder* > t_=t_data;
	int t_2=0;
	while(t_2<t_.Length()){
		DBG_BLOCK();
		c_flounder* t_t=t_.At(t_2);
		t_2=t_2+1;
		DBG_LOCAL(t_t,"t")
...
bool c_List::p_Equals(c_flounder* t_lhs,c_flounder* t_rhs){
	DBG_ENTER("List.Equals")
	c_List *self=this;
	DBG_LOCAL(self,"Self")
	DBG_LOCAL(t_lhs,"lhs")
	DBG_LOCAL(t_rhs,"rhs")
	DBG_INFO("C:/MonkeyXFree84f/modules/monkey/list.monkey<28>");
	bool t_=t_lhs==t_rhs;
	return t_;
}
int c_List::p_RemoveEach(c_flounder* t_value){
	DBG_ENTER("List.RemoveEach")
	c_List *self=this;
	DBG_LOCAL(self,"Self")
	DBG_LOCAL(t_value,"value")
	DBG_INFO("C:/MonkeyXFree84f/modules/monkey/list.monkey<151>");
	c_Node2* t_node=m__head->m__succ;
	DBG_LOCAL(t_node,"node")
	DBG_INFO("C:/MonkeyXFree84f/modules/monkey/list.monkey<152>");
	while(t_node!=m__head){
		DBG_BLOCK();
		DBG_INFO("C:/MonkeyXFree84f/modules/monkey/list.monkey<153>");
		c_Node2* t_succ=t_node->m__succ;
		DBG_LOCAL(t_succ,"succ")
		DBG_INFO("C:/MonkeyXFree84f/modules/monkey/list.monkey<154>");
		if(p_Equals(t_node->m__data,t_value)){
			DBG_BLOCK();
			t_node->p_Remove2();
		}
		DBG_INFO("C:/MonkeyXFree84f/modules/monkey/list.monkey<155>");
		t_node=t_succ;
	}
	return 0;
}
void c_List::p_Remove(c_flounder* t_value){
	DBG_ENTER("List.Remove")
	c_List *self=this;
	DBG_LOCAL(self,"Self")
	DBG_LOCAL(t_value,"value")
	DBG_INFO("C:/MonkeyXFree84f/modules/monkey/list.monkey<137>");
...
c_Node2* c_Node2::m_new(c_Node2* t_succ,c_Node2* t_pred,c_flounder* t_data){
	DBG_ENTER("Node.new")
	c_Node2 *self=this;
	DBG_LOCAL(self,"Self")
	DBG_LOCAL(t_succ,"succ")
...
int c_Node2::p_Remove2(){
	...
	c_Node2 *self=this;
	DBG_LOCAL(self,"Self")
	DBG_INFO("C:/MonkeyXFree84f/modules/monkey/list.monkey<274>");
	if(m__succ->m__pred!=this){
		DBG_BLOCK();
		bbError(String(L"Illegal operation on removed node",33));
	}
	DBG_INFO("C:/MonkeyXFree84f/modules/monkey/list.monkey<276>");
	gc_assign(m__succ->m__pred,m__pred);
	DBG_INFO("C:/MonkeyXFree84f/modules/monkey/list.monkey<277>");
...
c_alien::c_alien(){
	m_x=FLOAT(.0);
	m_y=FLOAT(.0);
	m_sprite=bb_graphics_LoadImage(String(L"log.png",7),1,c_Image::m_DefaultFlags);
}
c_alien* c_alien::m_new(int t_x_spawn,int t_y_spawn){
	DBG_ENTER("alien.new")
	c_alien *self=this;
	DBG_LOCAL(self,"Self")
	DBG_LOCAL(t_x_spawn,"x_spawn")
	DBG_LOCAL(t_y_spawn,"y_spawn")
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun original.monkey<148>");
	m_x=Float(t_x_spawn);
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun original.monkey<149>");
	m_y=Float(t_y_spawn);
	return this;
}
c_alien* c_alien::m_new2(){
	DBG_ENTER("alien.new")
	c_alien *self=this;
	DBG_LOCAL(self,"Self")
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun original.monkey<143>");
	return this;
}
void c_alien::mark(){
	Object::mark();
...
c_Node3* c_List2::p_AddLast2(c_alien* t_data){
	DBG_ENTER("List.AddLast")
	c_List2 *self=this;
	DBG_LOCAL(self,"Self")
	DBG_LOCAL(t_data,"data")
...
c_List2* c_List2::m_new2(Array<c_alien* > t_data){
	DBG_ENTER("List.new")
	c_List2 *self=this;
	DBG_LOCAL(self,"Self")
	DBG_LOCAL(t_data,"data")
	DBG_INFO("C:/MonkeyXFree84f/modules/monkey/list.monkey<13>");
	Array<c_alien* > t_=t_data;
	int t_2=0;
	while(t_2<t_.Length()){
		DBG_BLOCK();
		c_alien* t_t=t_.At(t_2);
		t_2=t_2+1;
		DBG_LOCAL(t_t,"t")
		DBG_INFO("C:/MonkeyXFree84f/modules/monkey/list.monkey<14>");
		p_AddLast2(t_t);
...
c_Node3* c_Node3::m_new(c_Node3* t_succ,c_Node3* t_pred,c_alien* t_data){
	DBG_ENTER("Node.new")
	c_Node3 *self=this;
	DBG_LOCAL(self,"Self")
	DBG_LOCAL(t_succ,"succ")
...
c_Laser::c_Laser(){
	m_x=FLOAT(.0);
	m_y=FLOAT(.0);
	m_sprite=bb_graphics_LoadImage(String(L"bubble.png",10),1,c_Image::m_DefaultFlags);
}
c_Laser* c_Laser::m_new(int t_x_spawn,int t_y_spawn){
	DBG_ENTER("Laser.new")
	c_Laser *self=this;
	DBG_LOCAL(self,"Self")
	DBG_LOCAL(t_x_spawn,"x_spawn")
	DBG_LOCAL(t_y_spawn,"y_spawn")
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun original.monkey<159>");
	m_x=Float(t_x_spawn+54);
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun original.monkey<160>");
	m_y=Float(t_y_spawn);
	return this;
}
c_Laser* c_Laser::m_new2(){
	DBG_ENTER("Laser.new")
	c_Laser *self=this;
	DBG_LOCAL(self,"Self")
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun original.monkey<153>");
	return this;
}
int c_Laser::p_Move(int t_y_distance){
	DBG_ENTER("Laser.Move")
	c_Laser *self=this;
	DBG_LOCAL(self,"Self")
	DBG_LOCAL(t_y_distance,"y_distance")
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun original.monkey<164>");
	m_y=m_y-Float(t_y_distance);
	return 0;
}
void c_Laser::mark(){
	Object::mark();
...
c_Node4* c_List3::p_AddLast3(c_Laser* t_data){
	DBG_ENTER("List.AddLast")
	c_List3 *self=this;
	DBG_LOCAL(self,"Self")
	DBG_LOCAL(t_data,"data")
...
c_List3* c_List3::m_new2(Array<c_Laser* > t_data){
	DBG_ENTER("List.new")
	c_List3 *self=this;
	DBG_LOCAL(self,"Self")
	DBG_LOCAL(t_data,"data")
	DBG_INFO("C:/MonkeyXFree84f/modules/monkey/list.monkey<13>");
	Array<c_Laser* > t_=t_data;
	int t_2=0;
	while(t_2<t_.Length()){
		DBG_BLOCK();
		c_Laser* t_t=t_.At(t_2);
		t_2=t_2+1;
		DBG_LOCAL(t_t,"t")
		DBG_INFO("C:/MonkeyXFree84f/modules/monkey/list.monkey<14>");
		p_AddLast3(t_t);
...
bool c_List3::p_Equals2(c_Laser* t_lhs,c_Laser* t_rhs){
	DBG_ENTER("List.Equals")
	c_List3 *self=this;
	DBG_LOCAL(self,"Self")
	DBG_LOCAL(t_lhs,"lhs")
...
int c_List3::p_RemoveEach2(c_Laser* t_value){
	DBG_ENTER("List.RemoveEach")
	c_List3 *self=this;
	DBG_LOCAL(self,"Self")
	DBG_LOCAL(t_value,"value")
...
void c_List3::p_Remove3(c_Laser* t_value){
	DBG_ENTER("List.Remove")
	c_List3 *self=this;
	DBG_LOCAL(self,"Self")
	DBG_LOCAL(t_value,"value")
...
c_Node4* c_Node4::m_new(c_Node4* t_succ,c_Node4* t_pred,c_Laser* t_data){
	DBG_ENTER("Node.new")
	c_Node4 *self=this;
	DBG_LOCAL(self,"Self")
	DBG_LOCAL(t_succ,"succ")
...
c_flounder* c_Enumerator2::p_NextObject(){
	DBG_ENTER("Enumerator.NextObject")
	c_Enumerator2 *self=this;
	DBG_LOCAL(self,"Self")
	DBG_INFO("C:/MonkeyXFree84f/modules/monkey/list.monkey<338>");
	c_flounder* t_data=m__curr->m__data;
	DBG_LOCAL(t_data,"data")
	DBG_INFO("C:/MonkeyXFree84f/modules/monkey/list.monkey<339>");
	gc_assign(m__curr,m__curr->m__succ);
	DBG_INFO("C:/MonkeyXFree84f/modules/monkey/list.monkey<340>");
...
bool bb_duckrun original_intersects(int t_x1,int t_y1,int t_w1,int t_h1,int t_x2,int t_y2,int t_w2,int t_h2){
	...
	DBG_LOCAL(t_w2,"w2")
	DBG_LOCAL(t_h2,"h2")
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun original.monkey<169>");
	if(t_x1>=t_x2+t_w2 || t_x1+t_w1<=t_x2){
		DBG_BLOCK();
		return false;
	}
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun original.monkey<170>");
	if(t_y1>=t_y2+t_h2 || t_y1+t_h1<=t_y2){
		DBG_BLOCK();
		return false;
	}
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun original.monkey<171>");
	return true;
}
int bb_duckrun original_score;
...
c_alien* c_Enumerator3::p_NextObject(){
	DBG_ENTER("Enumerator.NextObject")
	c_Enumerator3 *self=this;
	DBG_LOCAL(self,"Self")
	DBG_INFO("C:/MonkeyXFree84f/modules/monkey/list.monkey<338>");
	c_alien* t_data=m__curr->m__data;
	DBG_LOCAL(t_data,"data")
	DBG_INFO("C:/MonkeyXFree84f/modules/monkey/list.monkey<339>");
	gc_assign(m__curr,m__curr->m__succ);
	DBG_INFO("C:/MonkeyXFree84f/modules/monkey/list.monkey<340>");
...
String bb_duckrun original_currentdir;
int bbInit(){
	GC_CTOR
	bb_app__app=0;
	...
	bb_duckrun original_Game=0;
	DBG_GLOBAL("Game",&bb_duckrun original_Game);
	...
	bb_duckrun original_score=0;
	DBG_GLOBAL("score",&bb_duckrun original_score);
	bb_duckrun original_currentdir=String(L"right",5);
	DBG_GLOBAL("currentdir",&bb_duckrun original_currentdir);
	return 0;
}
void gc_mark(){
	gc_mark_q(bb_app__app);
	gc_mark_q(bb_app__delegate);
	gc_mark_q(bb_duckrun original_Game);
