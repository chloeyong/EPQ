...
extern c_Game_app* bb_duckrun version 2_Game;
int bbMain();
...
bool bb_duckrun version 2_intersects(int,int,int,int,int,int,int,int);
extern int bb_duckrun version 2_score;
...
extern String bb_duckrun version 2_currentdir;
...
c_Game_app* c_Game_app::m_new(){
	...
	DBG_LOCAL(self,"Self")
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 2.monkey<16>");
	c_App::m_new();
	return this;
}
int c_Game_app::p_OnCreate(){
	...
	c_Game_app *self=this;
	DBG_LOCAL(self,"Self")
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 2.monkey<28>");
	bb_audio_PlayMusic(String(L"RiverMusic.ogg",14),1);
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 2.monkey<29>");
	bb_app_SetUpdateRate(60);
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 2.monkey<30>");
	gc_assign(m_menu,bb_graphics_LoadImage(String(L"homepage.png",12),1,c_Image::m_DefaultFlags));
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 2.monkey<31>");
	gc_assign(m_background,bb_graphics_LoadImage(String(L"background.png",14),1,c_Image::m_DefaultFlags));
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 2.monkey<32>");
	gc_assign(m_player,(new c_Duck)->m_new());
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 2.monkey<33>");
	gc_assign(m_enemy_collection,(new c_List)->m_new());
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 2.monkey<35>");
	m_enemy_collection->p_AddLast((new c_alien)->m_new(75,0));
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 2.monkey<36>");
	m_enemy_collection->p_AddLast((new c_alien)->m_new(225,0));
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 2.monkey<37>");
	m_enemy_collection->p_AddLast((new c_alien)->m_new(375,0));
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 2.monkey<38>");
...
int c_Game_app::p_OnUpdate(){
	...
	c_Game_app *self=this;
	DBG_LOCAL(self,"Self")
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 2.monkey<43>");
	String t_1=m_GameState;
	DBG_LOCAL(t_1,"1")
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 2.monkey<44>");
	if(t_1==String(L"GAMEOVER",8)){
		DBG_BLOCK();
		DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 2.monkey<45>");
		...
		DBG_BLOCK();
		DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 2.monkey<46>");
		if(t_1==String(L"MENU",4)){
			DBG_BLOCK();
			DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 2.monkey<47>");
			...
			DBG_BLOCK();
			DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 2.monkey<48>");
			if(t_1==String(L"PLAYING",7)){
				DBG_BLOCK();
				DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 2.monkey<49>");
				if((bb_input_KeyHit(27))!=0){
					DBG_BLOCK();
					m_GameState=String(L"MENU",4);
				}
				DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 2.monkey<50>");
				if((bb_input_KeyDown(37))!=0){
					DBG_BLOCK();
					m_player->p_Move(-15);
				}
				DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 2.monkey<51>");
	...
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 2.monkey<57>");
	c_Enumerator* t_=m_enemy_collection->p_ObjectEnumerator();
	while(t_->p_HasNext()){
		DBG_BLOCK();
		c_alien* t_enemy=t_->p_NextObject();
		DBG_LOCAL(t_enemy,"enemy")
		DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 2.monkey<59>");
		if(bb_duckrun version 2_intersects(int(m_player->m_x),int(m_player->m_y),10,21,int(t_enemy->m_x),int(t_enemy->m_y),100,50)){
			DBG_BLOCK();
			DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 2.monkey<60>");
			bb_duckrun version 2_score=0;
		}
	}
	return 0;
}
int c_Game_app::p_OnRender(){
	...
	c_Game_app *self=this;
	DBG_LOCAL(self,"Self")
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 2.monkey<68>");
	String t_2=m_GameState;
	DBG_LOCAL(t_2,"2")
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 2.monkey<69>");
	if(t_2==String(L"MENU",4)){
		DBG_BLOCK();
		DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 2.monkey<70>");
		bb_graphics_DrawImage(m_menu,FLOAT(0.0),FLOAT(0.0),0);
	}else{
		DBG_BLOCK();
		DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 2.monkey<71>");
		if(t_2==String(L"GAMEOVER",8)){
			DBG_BLOCK();
			DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 2.monkey<72>");
			bb_graphics_DrawImage(m_gameover,FLOAT(0.0),FLOAT(0.0),0);
		}else{
			DBG_BLOCK();
			DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 2.monkey<73>");
			if(t_2==String(L"PLAYING",7)){
				DBG_BLOCK();
				DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 2.monkey<74>");
				bb_graphics_DrawImage(m_background,FLOAT(0.0),FLOAT(0.0),0);
				DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 2.monkey<76>");
				bb_graphics_DrawImage(m_player->m_sprite,m_player->m_x,m_player->m_y,0);
				DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 2.monkey<77>");
				bb_graphics_DrawText(String(bb_duckrun version 2_score),FLOAT(20.0),FLOAT(40.0),FLOAT(2.0),FLOAT(2.0));
				DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 2.monkey<78>");
				c_Enumerator* t_=m_enemy_collection->p_ObjectEnumerator();
				while(t_->p_HasNext()){
					DBG_BLOCK();
					c_alien* t_enemy=t_->p_NextObject();
					DBG_LOCAL(t_enemy,"enemy")
					DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 2.monkey<79>");
					bb_graphics_DrawImage(t_enemy->m_sprite,t_enemy->m_x,t_enemy->m_y,0);
					DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 2.monkey<81>");
					String t_3=bb_duckrun version 2_currentdir;
					DBG_LOCAL(t_3,"3")
					DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 2.monkey<82>");
					if(t_3==String(L"left",4)){
						DBG_BLOCK();
						DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 2.monkey<83>");
						t_enemy->m_y-=FLOAT(1.0);
					}else{
						DBG_BLOCK();
						DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 2.monkey<84>");
						if(t_3==String(L"right",5)){
							DBG_BLOCK();
							DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 2.monkey<85>");
							t_enemy->m_y+=FLOAT(1.0);
						}
					}
					DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 2.monkey<87>");
					if(t_enemy->m_y>FLOAT(464.0)){
						DBG_BLOCK();
						bb_duckrun version 2_currentdir=String(L"left",4);
					}
					DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 2.monkey<88>");
					if(t_enemy->m_y<FLOAT(0.0)){
						DBG_BLOCK();
						bb_duckrun version 2_currentdir=String(L"right",5);
					}
					DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 2.monkey<89>");
					if(bb_duckrun version 2_score<0){
						DBG_BLOCK();
...
BBGame* bb_app__game;
c_Game_app* bb_duckrun version 2_Game;
int bbMain(){
	DBG_ENTER("Main")
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 2.monkey<12>");
	gc_assign(bb_duckrun version 2_Game,(new c_Game_app)->m_new());
	return 0;
}
...
c_Duck* c_Duck::m_new(){
	...
	c_Duck *self=this;
	DBG_LOCAL(self,"Self")
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 2.monkey<98>");
	return this;
}
int c_Duck::p_Move(int t_x_distance){
	...
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 2.monkey<103>");
	m_x=m_x+Float(t_x_distance);
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 2.monkey<104>");
	if(m_x<FLOAT(0.0)){
		DBG_BLOCK();
		m_x=FLOAT(0.0);
	}
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 2.monkey<105>");
	if(m_x>FLOAT(590.0)){
		DBG_BLOCK();
		m_x=FLOAT(590.0);
	}
...
c_alien* c_alien::m_new(int t_x_spawn,int t_y_spawn){
	...
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 2.monkey<114>");
	m_x=Float(t_x_spawn);
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 2.monkey<115>");
	m_y=Float(t_y_spawn);
	return this;
}
c_alien* c_alien::m_new2(){
	...
	c_alien *self=this;
	DBG_LOCAL(self,"Self")
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 2.monkey<109>");
	return this;
}
void c_alien::mark(){
	Object::mark();
...
bool bb_duckrun version 2_intersects(int t_x1,int t_y1,int t_w1,int t_h1,int t_x2,int t_y2,int t_w2,int t_h2){
	...
	DBG_LOCAL(t_w2,"w2")
	DBG_LOCAL(t_h2,"h2")
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 2.monkey<124>");
	if(t_x1>=t_x2+t_w2 || t_x1+t_w1<=t_x2){
		DBG_BLOCK();
		return false;
	}
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 2.monkey<125>");
	if(t_y1>=t_y2+t_h2 || t_y1+t_h1<=t_y2){
		DBG_BLOCK();
		return false;
	}
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 2.monkey<126>");
	return true;
}
int bb_duckrun version 2_score;
int bb_graphics_DebugRenderDevice(){
...
String bb_duckrun version 2_currentdir;
int bbInit(){
	GC_CTOR
	bb_app__app=0;
	...
	bb_duckrun version 2_Game=0;
	DBG_GLOBAL("Game",&bb_duckrun version 2_Game);
	...
	bb_duckrun version 2_score=0;
	DBG_GLOBAL("score",&bb_duckrun version 2_score);
	bb_duckrun version 2_currentdir=String(L"right",5);
	DBG_GLOBAL("currentdir",&bb_duckrun version 2_currentdir);
	return 0;
}
void gc_mark(){
	gc_mark_q(bb_app__app);
	gc_mark_q(bb_app__delegate);
	gc_mark_q(bb_duckrun version 2_Game);
