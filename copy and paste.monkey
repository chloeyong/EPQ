...
enemy_collection.AddLast(New log(75,0))
enemy_collection.AddLast(New log(225,0))
'enemy_collection.AddLast(New log(375,0))
...
'If enemy.y>480 Then enemy_collection.Remove enemy
'Next
For Local enemy:=Eachin enemy_collection
...
If enemy.y<0 Then currentdir = "top"
'If enemy.y < 480 Then currentdir = "bottom"
If score <0 Then GameState = "GAMEOVER"
Next
'For Local log:=Eachin enemy_collection
'DrawImage log.sprite, log.x, log.y
'Next
End
End 
End
