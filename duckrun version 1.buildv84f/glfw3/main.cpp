...
extern c_Game_app* bb_duckrun version 1_Game;
int bbMain();
...
class c_List : public Object{
	...
	c_List();
	c_List* m_new();
	c_Node2* p_AddLast(c_alien*);
	c_List* m_new2(Array<c_alien* >);
	c_Enumerator* p_ObjectEnumerator();
	bool p_Equals(c_alien*,c_alien*);
	int p_RemoveEach(c_alien*);
	void p_Remove(c_alien*);
	void mark();
	String debug();
};
...
class c_Node2 : public Object{
	...
	c_alien* m__data;
	c_Node2();
	c_Node2* m_new(c_Node2*,c_Node2*,c_alien*);
	c_Node2* m_new2();
	int p_Remove2();
	void mark();
	String debug();
...
class c_List2 : public Object{
	...
	bool p_Equals2(c_Rocket*,c_Rocket*);
	int p_RemoveEach2(c_Rocket*);
	void p_Remove3(c_Rocket*);
	void mark();
	String debug();
};
...
class c_Node3 : public Object{
	...
	c_Rocket* m__data;
	c_Node3();
	c_Node3* m_new(c_Node3*,c_Node3*,c_Rocket*);
	c_Node3* m_new2();
	int p_Remove2();
	void mark();
	String debug();
...
bool bb_duckrun version 1_intersects(int,int,int,int,int,int,int,int);
...
extern int bb_duckrun version 1_score;
int bb_graphics_DrawText(String,Float,Float,Float,Float);
extern String bb_duckrun version 1_currentdir;
...
c_Game_app::c_Game_app(){
	...
	m_gameover=0;
	m_player_collection=0;
}
c_Game_app* c_Game_app::m_new(){
	DBG_ENTER("Game_app.new")
	c_Game_app *self=this;
	DBG_LOCAL(self,"Self")
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 1.monkey<16>");
	c_App::m_new();
	return this;
}
int c_Game_app::p_OnCreate(){
	...
	c_Game_app *self=this;
	DBG_LOCAL(self,"Self")
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 1.monkey<28>");
	bb_audio_PlayMusic(String(L"RiverMusic.ogg",14),1);
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 1.monkey<29>");
	bb_app_SetUpdateRate(60);
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 1.monkey<30>");
	gc_assign(m_menu,bb_graphics_LoadImage(String(L"homepage.png",12),1,c_Image::m_DefaultFlags));
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 1.monkey<31>");
	gc_assign(m_background,bb_graphics_LoadImage(String(L"background.png",14),1,c_Image::m_DefaultFlags));
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 1.monkey<32>");
	gc_assign(m_player,(new c_Rocket)->m_new());
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 1.monkey<33>");
	gc_assign(m_enemy_collection,(new c_List)->m_new());
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 1.monkey<34>");
	m_enemy_collection->p_AddLast((new c_alien)->m_new(75,0));
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 1.monkey<35>");
	m_enemy_collection->p_AddLast((new c_alien)->m_new(225,0));
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 1.monkey<36>");
	m_enemy_collection->p_AddLast((new c_alien)->m_new(375,0));
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 1.monkey<37>");
...
int c_Game_app::p_OnUpdate(){
	...
	c_Game_app *self=this;
	DBG_LOCAL(self,"Self")
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 1.monkey<42>");
	String t_1=m_GameState;
	DBG_LOCAL(t_1,"1")
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 1.monkey<43>");
	if(t_1==String(L"GAMEOVER",8)){
		DBG_BLOCK();
		DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 1.monkey<44>");
		...
		DBG_BLOCK();
		DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 1.monkey<45>");
		if(t_1==String(L"MENU",4)){
			DBG_BLOCK();
			DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 1.monkey<46>");
			...
			DBG_BLOCK();
			DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 1.monkey<47>");
			if(t_1==String(L"PLAYING",7)){
				DBG_BLOCK();
				DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 1.monkey<48>");
				if((bb_input_KeyHit(27))!=0){
					DBG_BLOCK();
					m_GameState=String(L"MENU",4);
				}
				DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 1.monkey<49>");
				if((bb_input_KeyDown(37))!=0){
					DBG_BLOCK();
					m_player->p_Move(-15);
				}
				DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 1.monkey<50>");
	...
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 1.monkey<53>");
	c_Enumerator* t_=m_enemy_collection->p_ObjectEnumerator();
	while(t_->p_HasNext()){
		DBG_BLOCK();
		c_alien* t_enemy=t_->p_NextObject();
		DBG_LOCAL(t_enemy,"enemy")
		DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 1.monkey<54>");
		if(t_enemy->m_y<FLOAT(10.0)){
			DBG_BLOCK();
			m_enemy_collection->p_Remove(t_enemy);
		}
	}
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 1.monkey<56>");
	c_Enumerator* t_2=m_enemy_collection->p_ObjectEnumerator();
	while(t_2->p_HasNext()){
		DBG_BLOCK();
		c_alien* t_enemy2=t_2->p_NextObject();
		DBG_LOCAL(t_enemy2,"enemy")
		DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 1.monkey<57>");
		c_Enumerator2* t_3=m_player_collection->p_ObjectEnumerator();
		while(t_3->p_HasNext()){
			DBG_BLOCK();
			c_Rocket* t_player=t_3->p_NextObject();
			DBG_LOCAL(t_player,"player")
			DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 1.monkey<58>");
			if(bb_duckrun version 1_intersects(int(t_player->m_x),int(t_player->m_y),10,21,int(t_enemy2->m_x),int(t_enemy2->m_y),100,50)){
				DBG_BLOCK();
				DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 1.monkey<59>");
				m_player_collection->p_Remove3(t_player);
			}
		}
	}
	return 0;
...
int c_Game_app::p_OnRender(){
	...
	c_Game_app *self=this;
	DBG_LOCAL(self,"Self")
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 1.monkey<68>");
	String t_2=m_GameState;
	DBG_LOCAL(t_2,"2")
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 1.monkey<69>");
	if(t_2==String(L"MENU",4)){
		DBG_BLOCK();
		DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 1.monkey<70>");
		bb_graphics_DrawImage(m_menu,FLOAT(0.0),FLOAT(0.0),0);
	}else{
		DBG_BLOCK();
		DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 1.monkey<71>");
		if(t_2==String(L"GAMEOVER",8)){
			DBG_BLOCK();
			DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 1.monkey<72>");
			bb_graphics_DrawImage(m_gameover,FLOAT(0.0),FLOAT(0.0),0);
		}else{
			DBG_BLOCK();
			DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 1.monkey<73>");
			if(t_2==String(L"PLAYING",7)){
				DBG_BLOCK();
				DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 1.monkey<74>");
				bb_graphics_DrawImage(m_background,FLOAT(0.0),FLOAT(0.0),0);
				DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 1.monkey<76>");
				bb_graphics_DrawImage(m_player->m_sprite,m_player->m_x,m_player->m_y,0);
				DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 1.monkey<77>");
				bb_graphics_DrawText(String(bb_duckrun version 1_score),FLOAT(20.0),FLOAT(40.0),FLOAT(2.0),FLOAT(2.0));
				DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 1.monkey<79>");
				c_Enumerator* t_=m_enemy_collection->p_ObjectEnumerator();
				while(t_->p_HasNext()){
					DBG_BLOCK();
					c_alien* t_enemy=t_->p_NextObject();
					DBG_LOCAL(t_enemy,"enemy")
					DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 1.monkey<80>");
					bb_graphics_DrawImage(t_enemy->m_sprite,t_enemy->m_x,t_enemy->m_y,0);
					DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 1.monkey<82>");
					String t_3=bb_duckrun version 1_currentdir;
					DBG_LOCAL(t_3,"3")
					DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 1.monkey<83>");
					if(t_3==String(L"bottom",6)){
						DBG_BLOCK();
						DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 1.monkey<84>");
						t_enemy->m_y=FLOAT(0.0);
					}
					DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 1.monkey<87>");
					if(t_enemy->m_y>FLOAT(464.0)){
						DBG_BLOCK();
						bb_duckrun version 1_currentdir=String(L"bottom",6);
					}
					DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 1.monkey<88>");
					if(bb_duckrun version 1_score<0){
						DBG_BLOCK();
						m_GameState=String(L"GAMEOVER",8);
					}
				}
				DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 1.monkey<90>");
				c_Enumerator* t_4=m_enemy_collection->p_ObjectEnumerator();
				while(t_4->p_HasNext()){
					DBG_BLOCK();
					c_alien* t_enemy2=t_4->p_NextObject();
					DBG_LOCAL(t_enemy2,"enemy")
					DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 1.monkey<91>");
					bb_graphics_DrawImage(t_enemy2->m_sprite,t_enemy2->m_x,t_enemy2->m_y,0);
				}
			}
		}
	}
...
String c_Game_app::debug(){
	...
	t+=dbg_decl("player_collection",&m_player_collection);
	return t;
}
c_App* bb_app__app;
...
BBGame* bb_app__game;
c_Game_app* bb_duckrun version 1_Game;
int bbMain(){
	DBG_ENTER("Main")
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 1.monkey<12>");
	gc_assign(bb_duckrun version 1_Game,(new c_Game_app)->m_new());
	return 0;
}
...
c_Rocket* c_Rocket::m_new(){
	...
	c_Rocket *self=this;
	DBG_LOCAL(self,"Self")
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 1.monkey<97>");
	return this;
}
int c_Rocket::p_Move(int t_x_distance){
	...
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 1.monkey<102>");
	m_x=m_x+Float(t_x_distance);
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 1.monkey<103>");
	if(m_x<FLOAT(0.0)){
		DBG_BLOCK();
		m_x=FLOAT(0.0);
	}
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 1.monkey<104>");
	if(m_x>FLOAT(590.0)){
		DBG_BLOCK();
		m_x=FLOAT(590.0);
	}
...
c_alien* c_alien::m_new(int t_x_spawn,int t_y_spawn){
	...
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 1.monkey<113>");
	m_x=Float(t_x_spawn);
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 1.monkey<114>");
	m_y=Float(t_y_spawn);
	return this;
}
c_alien* c_alien::m_new2(){
	...
	c_alien *self=this;
	DBG_LOCAL(self,"Self")
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 1.monkey<108>");
	return this;
}
void c_alien::mark(){
	Object::mark();
...
c_Node2* c_List::p_AddLast(c_alien* t_data){
...
c_List* c_List::m_new2(Array<c_alien* > t_data){
	DBG_ENTER("List.new")
	c_List *self=this;
	DBG_LOCAL(self,"Self")
	DBG_LOCAL(t_data,"data")
...
bool c_List::p_Equals(c_alien* t_lhs,c_alien* t_rhs){
...
int c_List::p_RemoveEach(c_alien* t_value){
...
void c_List::p_Remove(c_alien* t_value){
...
c_Node2* c_Node2::m_new(c_Node2* t_succ,c_Node2* t_pred,c_alien* t_data){
	DBG_ENTER("Node.new")
	c_Node2 *self=this;
	DBG_LOCAL(self,"Self")
	DBG_LOCAL(t_succ,"succ")
...
c_alien* c_Enumerator::p_NextObject(){
...
bool c_List2::p_Equals2(c_Rocket* t_lhs,c_Rocket* t_rhs){
	DBG_ENTER("List.Equals")
	c_List2 *self=this;
	DBG_LOCAL(self,"Self")
	DBG_LOCAL(t_lhs,"lhs")
...
int c_List2::p_RemoveEach2(c_Rocket* t_value){
	DBG_ENTER("List.RemoveEach")
	c_List2 *self=this;
	DBG_LOCAL(self,"Self")
	DBG_LOCAL(t_value,"value")
...
void c_List2::p_Remove3(c_Rocket* t_value){
	DBG_ENTER("List.Remove")
	c_List2 *self=this;
	DBG_LOCAL(self,"Self")
	DBG_LOCAL(t_value,"value")
...
c_Rocket* c_Enumerator2::p_NextObject(){
	DBG_ENTER("Enumerator.NextObject")
	c_Enumerator2 *self=this;
	DBG_LOCAL(self,"Self")
	DBG_INFO("C:/MonkeyXFree84f/modules/monkey/list.monkey<338>");
	c_Rocket* t_data=m__curr->m__data;
	DBG_LOCAL(t_data,"data")
	DBG_INFO("C:/MonkeyXFree84f/modules/monkey/list.monkey<339>");
	gc_assign(m__curr,m__curr->m__succ);
	DBG_INFO("C:/MonkeyXFree84f/modules/monkey/list.monkey<340>");
...
c_Node3* c_Node3::m_new(c_Node3* t_succ,c_Node3* t_pred,c_Rocket* t_data){
	DBG_ENTER("Node.new")
	c_Node3 *self=this;
	DBG_LOCAL(self,"Self")
	DBG_LOCAL(t_succ,"succ")
...
bool bb_duckrun version 1_intersects(int t_x1,int t_y1,int t_w1,int t_h1,int t_x2,int t_y2,int t_w2,int t_h2){
	...
	DBG_LOCAL(t_w2,"w2")
	DBG_LOCAL(t_h2,"h2")
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 1.monkey<134>");
	if(t_x1>=t_x2+t_w2 || t_x1+t_w1<=t_x2){
		DBG_BLOCK();
		return false;
	}
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 1.monkey<135>");
	if(t_y1>=t_y2+t_h2 || t_y1+t_h1<=t_y2){
		DBG_BLOCK();
		return false;
	}
	DBG_INFO("C:/Users/User/Documents/Chloe/Yr 13/EPQ/Duck Run/duckrun version 1.monkey<136>");
	return true;
}
int bb_graphics_DebugRenderDevice(){
...
int bb_duckrun version 1_score;
...
String bb_duckrun version 1_currentdir;
int bbInit(){
	GC_CTOR
	bb_app__app=0;
	...
	bb_duckrun version 1_Game=0;
	DBG_GLOBAL("Game",&bb_duckrun version 1_Game);
	...
	bb_duckrun version 1_score=0;
	DBG_GLOBAL("score",&bb_duckrun version 1_score);
	bb_duckrun version 1_currentdir=String(L"right",5);
	DBG_GLOBAL("currentdir",&bb_duckrun version 1_currentdir);
	return 0;
}
void gc_mark(){
	gc_mark_q(bb_app__app);
	gc_mark_q(bb_app__delegate);
	gc_mark_q(bb_duckrun version 1_Game);
